...
// Consulta para obtener las cotizaciones
$query = "SELECT ht.ID_HorarioTecnico, ht.ID_Usuario, ht.Dia_Inicio_Semana, ht.Dia_Fin_Semana, ht.Horario_Inicio, ht.Horario_Fin, u.nombres, u.apellidos FROM horariostecnicos ht INNER JOIN tb_usuarios u ON ht.ID_Usuario = u.ID_Usuario";
try {
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <thead>
                                    <tr>
                                        <th data-priority="1">Nombre del Técnico</th>
                                        <th data-priority="1">Apellido del Técnico</th>

                                        <th data-priority="2">Dia Inicio Semana</th>
                                        <th data-priority="3">Dia Fin Semana</th>
                                        <th data-priority="4">Horario Inicio</th>
                                        <th data-priority="5">Horario Fin</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tecnicos as $tecnico) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-primary" onclick="llenarModal(<?php echo htmlspecialchars(json_encode($tecnico)); ?>)">
                                                    <i class="fas fa-edit"></i>
                                                </a>

                                                <a href="#" class="btn btn-danger" onclick="eliminarTecnico(<?php echo $tecnico['ID_HorarioTecnico']; ?>)">
...
<script>
    ...
    function llenarModal(tecnico) {
        ...
        document.getElementById('editIdUsuario').value = tecnico.id_usuario;
