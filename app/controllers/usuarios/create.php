...
try {
    ...
    $sentencia = $pdo->prepare("INSERT INTO tb_usuarios 
        (cedula, nombres, apellidos, id_rol, telefono_empl, email, direccion_emple, password_user) 
        VALUES (:cedula, :nombres, :apellidos, :id_rol, :telefono_empl, :email, :direccion_emple, :password_user)");
